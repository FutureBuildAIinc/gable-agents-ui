...
{/* i18n-copy-ignore: localized copies predate this link list; this source-only label follows the retained embedding slug. */}
...
- [**Embed Clips**](/docs/template-clips-developers) — add anonymous recording to another product.
