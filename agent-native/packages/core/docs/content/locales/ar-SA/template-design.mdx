...
- **ابدأ من قوالب قابلة لإعادة الاستخدام.** اختر مقاسًا جاهزًا للإعلانات أو مستندات الصفحة الواحدة أو صفحات الهبوط، أو احفظ أي تصميم مضمّن كقالب. تعدّل المطالبة المحتوى غير المقفل فقط وتحافظ على الشعارات والخلفيات المقفلة.
...
المستخدمون غير المسجلين إلى `/sign-in?return=...`، ثم يحفظ Design
