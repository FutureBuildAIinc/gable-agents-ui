...
<WireframeBlock id="doc-block-bbd0n3">
  <Screen
    surface="desktop"
    html={
      "<div style='display:flex;flex-direction:column;gap:14px;padding:18px;min-height:520px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:10px'><h1 style='margin:0'>उत्पाद लॉन्च पेज</h1><span class='wf-pill accent'>Desktop</span><span class='wf-pill'>Tablet</span><span class='wf-pill'>Mobile</span><div style='flex:1'></div><button>Preview</button><button class='primary'>Export code</button></div><div class='wf-card' style='flex:1;display:grid;grid-template-rows:auto 1fr auto;gap:12px'><div style='display:flex;gap:8px'><span class='wf-pill accent'>Hero</span><span class='wf-pill'>Pricing</span><span class='wf-pill'>FAQ</span></div><div class='wf-box' style='display:flex;flex-direction:column;gap:12px;min-height:230px;padding:20px'><div style='display:flex;flex-direction:column;align-items:center;gap:8px;text-align:center'><strong style='font-size:22px'>Agent-Native के साथ तेज़ी से लॉन्च करें</strong><span class='wf-muted' style='max-width:70%'>एक prompt से काम करने वाला prototype बनाएँ, फिर उसे वहीं बेहतर करें।</span><button class='primary'>शुरू करें</button></div><div style='display:grid;grid-template-columns:repeat(3,1fr);gap:10px;flex:1'><div class='wf-card' style='min-height:56px'></div><div class='wf-card' style='min-height:56px'></div><div class='wf-card' style='min-height:56px'></div></div></div><div class='wf-card' style='display:flex;align-items:center;gap:10px'><span class='wf-muted'>हीरो को अधिक सघन और CTA को अधिक स्पष्ट बनाएं।</span><div style='flex:1'></div><button class='primary'>संशोधन लागू करें</button></div></div></div>"
    }
  />
</WireframeBlock>
...
- **दोबारा उपयोग होने वाले टेम्पलेट से शुरू करें।** विज्ञापन, एक-पेज दस्तावेज़ या लैंडिंग पेज के लिए तय आकार चुनें, या किसी इनलाइन डिज़ाइन को टेम्पलेट के रूप में सहेजें। प्रॉम्प्ट केवल अनलॉक सामग्री बदलता है और लॉक लोगो व पृष्ठभूमि को सुरक्षित रखता है।
...
नीचे दी गई तालिका मुख्य स्वामित्व योग्य संसाधनों — डिज़ाइन, फ़ाइलें, टेम्पलेट, संस्करण और डिज़ाइन सिस्टम — को कवर करती है। इसी स्कीमा की सात अन्य तालिकाएँ मुख्य संसाधन मॉडल के बजाय इस दस्तावेज़ में अन्यत्र बताई गई सुविधाओं का समर्थन करती हैं: `design_localhost_connections` और `design_localhost_write_grants` (localhost स्रोत मोड), `component_index` (घटक इंडेक्सिंग), `motion_timeline` (मोशन), `design_state` (एडिटर स्थिति स्नैपशॉट), `design_fusion_edits` (पूर्ण-ऐप फ़्यूज़न मोड), और `design_review_snapshot` (समीक्षा स्नैपशॉट)।
...
`/sign-in?return=...` से गुजरते हैं, फिर Design share dialog खोलने
