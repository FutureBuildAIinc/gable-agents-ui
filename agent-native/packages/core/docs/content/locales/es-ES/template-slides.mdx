...
<WireframeBlock id="doc-block-19dzcqp">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-gqrq0j" title="Incitar a cubierta" summary={"Solicite una plataforma y el agente transmitirá las diapositivas una a la vez a través de las mismas acciones que podría llamar desde CLI."}>
...
<DataModel
  id="doc-block-1a4c35p"
  title="Modelo de datos Slides"
  summary={
    "Un deck posee sus diapositivas como JSON en decks.data; comentarios, versiones, compartidos y sistemas de diseño cuelgan de él."
  }
  entities={[
    {
      id: "decks",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "slide_id",
          type: "text",
          note: "Desliza el comentario sigue vivo",
        },
        {
          name: "thread_id",
          type: "text",
...
La creación, edición y eliminación de presentaciones y diapositivas usa actions compartidas como `create-deck`, `add-slide`, `update-slide` y `delete-deck`, que pueden invocar tanto el agente como la interfaz. Las rutas REST de `templates/slides/server/routes/api/` se reservan para cargas, streaming, exportaciones y otros flujos exclusivos de rutas.
