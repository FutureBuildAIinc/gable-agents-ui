...
<WireframeBlock id="doc-block-12cmmvq">
  <Screen
    surface="desktop"
    html={
      "<div style='display:flex;flex-direction:column;gap:12px;padding:16px;min-height:530px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:10px'><h1 style='margin:0'>Q3-Update für den Vorstand</h1><span class='wf-pill accent'>Titelfolie</span><div style='flex:1'></div><button>Preview</button><button>Present</button><button class='primary'>Teilen</button></div><main style='display:grid;grid-template-columns:1fr 220px;gap:12px;flex:1;min-height:0'><section class='wf-card' style='display:flex;align-items:center;justify-content:center;text-align:center;padding:36px'><div><strong style='font-size:28px'>Q3-Update für den Vorstand</strong><br/><small>Maya Chen · Geschäftsführerin</small><div style='height:46px'></div><span class='wf-pill'>Produktdynamik</span></div></section><section style='display:flex;flex-direction:column;gap:10px'><div class='wf-card'><strong>Foliengliederung</strong><div class='wf-box'>1 Titel</div><div class='wf-box'>2 Tagesordnung</div><div class='wf-box'>3 Metriken</div><div class='wf-box'>4 Ausgeliefert</div></div><div class='wf-card' style='flex:1'><strong>Sprechernotizen</strong><p class='wf-muted' style='margin:8px 0 0'>Mit Launch-Fortschritt und Retention-Story beginnen.</p></div></section></main><div style='display:grid;grid-template-columns:repeat(5,1fr);gap:8px'><div class='wf-box'>1 Titel</div><div class='wf-box'>2 Tagesordnung</div><div class='wf-box'>3 Metriken</div><div class='wf-box'>4 Ausgeliefert</div><div class='wf-box'>5 Risiken</div></div></div>"
    }
  />
</WireframeBlock>
...
<Diagram id="doc-block-1jzmhxo" title="Aufforderung zum Deck" summary={"Fragen Sie nach einem Deck, und der Agent streamt Folien nacheinander durch die gleichen Aktionen, die Sie vom CLI aus aufrufen könnten."}>
...
<DataModel
  id="doc-block-19af6z0"
  title="Slides-Datenmodell"
  summary={
  ...
  entities={[
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "slide_id",
          type: "text",
          note: "Slide, der Kommentar lebt weiter",
        },
        {
          name: "thread_id",
          type: "text",
    ...
    },
    {
      ...
      note: "Persistente öffentliche Freigabe-Link-Snapshots",
      fields: [
        {
          name: "token",
          type: "text",
        ...
        },
        {
          name: "slides",
          type: "text",
          note: "JSON Folien-Schnappschuss",
        },
        {
          name: "aspect_ratio",
          type: "text",
...
#### Actions und API-Routen

Das Erstellen, Bearbeiten und Löschen von Decks und Folien verwendet gemeinsame Actions wie `create-deck`, `add-slide`, `update-slide` und `delete-deck`, die sowohl der Agent als auch die UI aufrufen können. REST-Routen unter `templates/slides/server/routes/api/` sind für Uploads, Streaming, Exporte und andere reine Routenabläufe reserviert.
