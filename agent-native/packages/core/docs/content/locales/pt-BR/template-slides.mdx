...
<WireframeBlock id="doc-block-16kofdr">
  <Screen
    surface="desktop"
    html={
      "<div style='display:flex;flex-direction:column;gap:12px;padding:16px;min-height:530px;box-sizing:border-box'><div style='display:flex;align-items:center;gap:10px'><h1 style='margin:0'>Atualização do conselho no T3</h1><span class='wf-pill accent'>Slide de título</span><div style='flex:1'></div><button>Preview</button><button>Present</button><button class='primary'>Compartilhar</button></div><main style='display:grid;grid-template-columns:1fr 220px;gap:12px;flex:1;min-height:0'><section class='wf-card' style='display:flex;align-items:center;justify-content:center;text-align:center;padding:36px'><div><strong style='font-size:28px'>Atualização do conselho no T3</strong><br/><small>Maya Chen · diretora executiva</small><div style='height:46px'></div><span class='wf-pill'>Impulso do produto</span></div></section><section style='display:flex;flex-direction:column;gap:10px'><div class='wf-card'><strong>Esboço do slide</strong><div class='wf-box'>1 Título</div><div class='wf-box'>2 Pauta</div><div class='wf-box'>3 Métricas</div><div class='wf-box'>4 Enviado</div></div><div class='wf-card' style='flex:1'><strong>Notas do apresentador</strong><p class='wf-muted' style='margin:8px 0 0'>Abrir com progresso do lançamento e história de retenção.</p></div></section></main><div style='display:grid;grid-template-columns:repeat(5,1fr);gap:8px'><div class='wf-box'>1 Título</div><div class='wf-box'>2 Pauta</div><div class='wf-box'>3 Métricas</div><div class='wf-box'>4 Enviado</div><div class='wf-box'>5 Riscos</div></div></div>"
    }
  />
</WireframeBlock>
...
<Diagram id="doc-block-ibzjph" title={"Solicitar a apresentação"} summary={"Peça uma apresentação e o agente transmitirá os slides, um de cada vez, por meio das mesmas ações que você poderia chamar do CLI."}>
...
Todos os dados do deck ficam em SQL com Drizzle ORM. Esquema: `templates/slides/server/db/schema.ts`.

<DataModel
  id="doc-block-1gbgyel"
  ...
  entities={[
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "slide_id",
          type: "text",
          note: "Deslize o comentário ao vivo",
        },
        {
          name: "thread_id",
          type: "text",
    ...
    },
    {
      id: "deck_versions",
      name: "deck_versions",
      note: "Instantâneos pontuais para restauração",
      fields: [
        {
          name: "deck_id",
          type: "text",
    ...
    },
    {
      ...
      note: "Instantâneos de link de compartilhamento público persistentes",
      fields: [
        {
          name: "token",
          type: "text",
        ...
        },
        {
          name: "slides",
          type: "text",
          note: "JSON instantâneo dos slides",
        },
        {
          name: "aspect_ratio",
          type: "text",
...
A criação, edição e exclusão de decks e slides usa actions compartilhadas como `create-deck`, `add-slide`, `update-slide` e `delete-deck`, que podem ser chamadas pelo agente e pela UI. As rotas REST em `templates/slides/server/routes/api/` ficam reservadas para uploads, streaming, exportações e outros fluxos exclusivos de rotas.
