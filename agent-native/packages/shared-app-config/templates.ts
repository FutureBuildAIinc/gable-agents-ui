...
export const TEMPLATES: TemplateMeta[] = [
  ...
  {
    name: "gable-inventory",
    label: "Gable Inventory",
    hint: "Agent-native inventory/PIM on the Gable ERP — stock, adjustments, transfers, and reorder alerts",
    icon: "Packages",
    color: "#D97706",
    colorRgb: "217 119 6",
    devPort: 8110,
  ...
  {
    name: "gable-dispatch",
    label: "Gable Dispatch",
    hint: "Agent-native loading/picking/dispatch on the Gable ERP — build routes, dispatch trucks, complete deliveries",
    icon: "Truck",
    color: "#EA580C",
    colorRgb: "234 88 12",
    devPort: 8111,
  ...
  },
  {
    name: "gable-ar",
    label: "Gable AR",
    hint: "Agent-native invoicing/accounts-receivable on the Gable ERP — invoices, payments, refunds, and AR history",
    icon: "Receipt",
    color: "#0D9488",
    colorRgb: "13 148 136",
    devPort: 8112,
