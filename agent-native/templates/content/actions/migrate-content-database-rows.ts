...
export const operationalSchema = z.discriminatedUnion("phase", [
  validateSchema,
  applySchema,
  verifySchema,
  rollbackSchema,
...
export const safeOperationalSchema = z.discriminatedUnion("phase", [
  validateSchema,
  applySchema,
  verifySchema,
]);
export const approvalOperationalSchema = z.discriminatedUnion("phase", [
  rollbackSchema,
  finalizeSchema,
]);
export type MigrationInput = z.infer<typeof operationalSchema>;
...
export const migrationAudit = {
  recordInputs: false,
  target: (args: MigrationInput) => ({
