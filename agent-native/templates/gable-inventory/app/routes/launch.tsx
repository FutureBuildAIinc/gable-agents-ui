...
export function meta() {
  return [{ title: "Launcher — Gable Inventory" }];
}
...
const ACTIONS = [
  {
    ...
    icon: IconPlus,
    title: "Count sheet",
    description: "Blind cycle counts by location/bin — enter counts, agent narrates the variances.",
    agentDriver: "Builds the count list, reasons over variances, drafts adjustments",
  },
  {
    path: "/inventory",
    icon: IconClipboardList,
    title: "Availability",
    description: "On-hand vs allocated vs available by location and bin, UOM-correct.",
    agentDriver: "Answers counter availability questions with alternates",
  },
  {
    path: "/inventory/reorder",
    icon: IconPackage,
    title: "Reorder review",
    description: "SKUs below reorder point with 30-day velocity and suggested quantities.",
    agentDriver: "Digests the alerts, suggests PO lines, explains any line",
  },
] as const;
