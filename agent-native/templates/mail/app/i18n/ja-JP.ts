const messages = {
  ...
  mail: {
    ...
    compose: {
      ...
      send: "送信",
      sending: "送信中...",
      hideCcBcc: "Cc と Bcc を非表示",
      showCcBcc: "Cc と Bcc を表示",
      strikethrough: "取り消し線",
      subject: "Subject",
      to: "宛先",
      toRecipients: "宛先の受信者",
      cc: "Cc",
      ccRecipients: "Cc の受信者",
      bcc: "Bcc",
      bccRecipients: "Bcc の受信者",
      toSubmit: "to submit",
      uploading: "アップロード中...",
    ...
    recipients: {
      ...
      removeRecipient: "受信者 {{recipient}} を削除",
    ...
    thread: {
      ...
      maximize: "最大化",
      minimize: "最小化",
      nextConversation: "次のスレッド",
      nextMatch: "次の一致",
      previousConversation: "前のスレッド",
      previousMatch: "前の一致",
      remoteImagesHidden: "この埋め込みではリモート画像が非表示です。",
      searchConversation: "会話内を検索...",
      searchConversationLabel: "会話内を検索",
      showImages: "画像を表示",
  ...
  commandPalette: {
    ...
    shortcutsGlobal: "全体",
    shortcutsList: "メール一覧",
    shortcutsThread: "スレッド",
    shortcutsCompose: "作成",
    backToCommands: "コマンドに戻る",
    backToMessageList: "メッセージ一覧に戻る",
    cycleTabs: "タブを切り替える",
    extendSelection: "選択範囲を広げる",
    moveSelection: "選択を移動",
    nextPreviousConversation: "次 / 前の会話",
    nextPreviousMessage: "次 / 前のメッセージ",
    openMessage: "メールを開く",
    selectAllConversations: "すべての会話を選択",
    sendAndMarkDone: "送信して完了にする",
    toggleMessageExpansion: "メッセージを展開 / 折りたたむ",
    toggleReadState: "既読状態を切り替える",
  },
};
