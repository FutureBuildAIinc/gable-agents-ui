const messages = {
  ...
  mail: {
    ...
    compose: {
      ...
      send: "보내기",
      sending: "보내는 중...",
      hideCcBcc: "참조 및 숨은참조 숨기기",
      showCcBcc: "참조 및 숨은참조 표시",
      strikethrough: "취소선",
      subject: "Subject",
      to: "받는 사람",
      toRecipients: "받는 사람 수신자",
      cc: "참조",
      ccRecipients: "참조 수신자",
      bcc: "숨은참조",
      bccRecipients: "숨은참조 수신자",
      toSubmit: "to submit",
      uploading: "업로드 중...",
    ...
    recipients: {
      ...
      removeRecipient: "수신자 {{recipient}} 삭제",
      saveAsAlias: "별칭으로 저장",
      saving: "저장 중...",
    },
    sendLater: {
  ...
  commandPalette: {
    ...
    shortcutsThread: "대화",
    shortcutsCompose: "작성",
    backToCommands: "명령으로 돌아가기",
    backToMessageList: "메시지 목록으로 돌아가기",
    cycleTabs: "탭 전환",
    extendSelection: "선택 영역 확장",
    moveSelection: "선택 항목 이동",
    nextPreviousConversation: "다음 / 이전 대화",
    nextPreviousMessage: "다음 / 이전 메시지",
    openMessage: "메일 열기",
    selectAllConversations: "모든 대화 선택",
    sendAndMarkDone: "보내고 완료로 표시",
    toggleMessageExpansion: "메시지 펼치기 / 접기",
    toggleReadState: "읽음 상태 전환",
  },
};
