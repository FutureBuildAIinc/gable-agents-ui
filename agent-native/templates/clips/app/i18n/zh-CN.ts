const messages = {
  ...
  recordingPage: {
    ...
    chaptersGenerated: "章节已生成",
    fillerCompleted: "填充词移除完成",
    workflowReady: "工作流已就绪",
    workflowFailed: "工作流生成失败",
    transcriptionCompleted: "转录完成",
    transcriptNotReady: "成绩单尚未准备好",
    tryAfterTranscription: "转录完成后重试。",
    titleGenerationQueued: "正在生成标题…",
    descriptionQueued: "正在生成描述…",
    chapterQueued: "正在生成章节…",
    fillerQueued: "正在移除填充词…",
    silenceQueued: "正在移除静音…",
    workflowQueued: "正在生成工作流…",
    pageTitle: "剪辑录制·Clips",
    ...
    cleanUpRecording: "清理录制内容",
    createFromClip: "从片段创建",
  ...
  recordingInsights: {
    ...
    moreInsights: "更多洞察",
    connectAnalytics: "连接到 Agent-Native Analytics",
    connectAnalyticsTitle: "在 Agent-Native Analytics 中继续",
    exploreWithAgent: "与智能体一起探索",
    startChatAction: "开始对话",
    trackInDashboard: "在仪表板中跟踪",
    chooseDashboardAction: "选择仪表板",
  },
  libraryGrid: {
    spaceRoot: "空间根目录",
    libraryRoot: "资料库根目录",
  ...
  dictateRoute: {
    ...
    dictionaryTitle: "词典",
    dictionaryAutoLearn: "桌面端会从更正中学习",
    dictionaryAddTerms: "添加词条",
    dictionaryImport: "导入",
    dictionaryExport: "导出 CSV",
    dictionaryImportFailed: "请选择包含有效词条的 CSV、TSV 或文本文件。",
  ...
  browserDiagnostics: {
    ...
    input: "输入",
    scroll: "滚动",
    requestStarted: "请求已发出",
    responseReceived: "已收到响应",
    issues: "问题",
    consoleSource: "控制台",
    networkSource: "网络",
    consoleCount: "控制台 {{count}}",
    networkCount: "网络 {{count}}",
    afterRecording: "录制结束后",
    seekToTime: "跳转到 {{time}}",
    occurrences: "出现时间",
    message: "消息",
    stackTrace: "堆栈跟踪",
    ...
    duration: "耗时",
    error: "错误",
    noIssuesTitle: "未检测到浏览器问题",
    noConsoleTitle: "没有控制台事件",
    noNetworkTitle: "没有网络请求",
    capturedDescription: "已为此录制采集诊断信息。",
  },
