const messages = {
  ...
  navigation: {
    ...
    newFolder: "新建資料夾",
    noSpaces: "暫無空間",
    noSpacesAdminCta: "請聯絡組織管理員建立第一個空間。",
    desktopCta: "取得桌面應用",
  ...
  recordingPage: {
    ...
    chaptersGenerated: "章節已產生",
    fillerCompleted: "填充詞移除完成",
    workflowReady: "工作流已準備完成",
    workflowFailed: "工作流產生失敗",
    transcriptionCompleted: "轉錄完成",
    transcriptNotReady: "逐字稿尚未準備好",
    tryAfterTranscription: "轉錄完成後重試。",
    titleGenerationQueued: "正在產生標題…",
    descriptionQueued: "正在產生描述…",
    chapterQueued: "正在產生章節…",
    fillerQueued: "正在移除填充詞…",
    silenceQueued: "正在移除靜音…",
    workflowQueued: "正在產生工作流…",
    pageTitle: "剪輯錄製 · Clips",
    ...
    cleanUpRecording: "清理錄製內容",
    createFromClip: "從片段建立",
  ...
  recordingInsights: {
    ...
    moreInsights: "更多洞察",
    connectAnalytics: "連接到 Agent-Native Analytics",
    connectAnalyticsTitle: "在 Agent-Native Analytics 中繼續",
    exploreWithAgent: "與代理一起探索",
    startChatAction: "開始對話",
    trackInDashboard: "在儀表板中追蹤",
    chooseDashboardAction: "選擇儀表板",
  },
  libraryGrid: {
    spaceRoot: "空間根目錄",
    libraryRoot: "資料庫根目錄",
  ...
  cameraVisualizer: {
    ...
    needsAttention: "檢查攝影機",
    unsupported: "此瀏覽器不支援即時攝影機檢測。",
    policyBlocked: "此頁面阻止了攝影機存取。請直接開啟 Clips 後重試。",
    secureContextRequired: "攝影機檢測需要 HTTPS 或 localhost。",
    permissionBlocked:
      "攝影機存取已被阻止。請在此網站的設定中允許存取，然後重新載入頁面。",
    permissionDenied:
      "攝影機存取已被拒絕。請檢查網站的攝影機設定和系統隱私設定，然後重新載入頁面。",
    notFound: "找不到攝影機。請連接攝影機或選擇其他攝影機。",
    inUse: "攝影機正由其他應用程式使用。請關閉該應用程式或選擇其他攝影機。",
    startFailed: "無法啟動攝影機檢測。",
    disconnected: "攝影機已中斷連線。",
    noVideo: "未偵測到攝影機畫面。",
  },
  microphoneVisualizer: {
    off: "關閉",
    needsAttention: "檢查麥克風",
    signal: "有訊號",
    listening: "正在聆聽",
    opening: "正在開啟",
    openingEllipsis: "正在開啟...",
    stop: "停止",
    test: "測試麥克風",
    unsupported: "此瀏覽器不支援即時麥克風檢測。",
    policyBlocked: "此頁面阻止了麥克風存取。請直接開啟 Clips 後重試。",
    secureContextRequired: "麥克風檢測需要 HTTPS 或 localhost。",
    permissionBlockedBrowser:
      "麥克風存取已被阻止。請在此網站的設定中允許存取，然後重新載入頁面。",
    permissionBlockedDesktop:
      "麥克風存取已被阻止。請在系統隱私設定中允許存取，然後重新開啟錄製器。",
    permissionDenied:
      "麥克風存取已被拒絕。請檢查網站的麥克風設定和系統隱私設定，然後重新載入頁面。",
    notFound: "找不到麥克風。請連接麥克風或選擇其他輸入。",
    inUse: "麥克風正由其他應用程式使用。請關閉該應用程式或選擇其他輸入。",
    startFailed: "無法啟動麥克風檢測。",
  ...
  preRecord: {
    ...
    moreCameras: "更多攝影機…",
    cameraPickerTitle: "選擇攝影機",
    moreMicrophones: "更多麥克風…",
    microphonePickerTitle: "選擇麥克風",
    closeDevicePicker: "關閉裝置選擇器",
    noAudio: "沒有音訊",
    noCamera: "沒有攝影機",
  ...
  dictateRoute: {
    ...
    dictionaryTitle: "字典",
    dictionaryAutoLearn: "桌面版會從更正中學習",
    dictionaryAddTerms: "新增詞條",
    dictionaryImport: "匯入",
    dictionaryExport: "匯出 CSV",
    dictionaryImportFailed: "請選擇包含有效詞條的 CSV、TSV 或文字檔。",
    dictionaryExported: "字典已匯出",
    dictionaryTermsPlaceholder: "Agent-Native\n代理原生 → Agent-Native",
    dictionaryTermsRequired: "請至少輸入一個詞條。",
    dictionarySearch: "搜尋字典",
    dictionaryNoMatches: "沒有相符的詞條。",
    dictionaryRemoveTitle: "移除「{{term}}」？",
    dictionaryRemoveDescription: "之後的聽寫將不再使用此更正。",
  ...
  meetingsRoute: {
    ...
    howToTriggerDescription:
      "Clips 的會議筆記會將日曆事件、桌面音訊擷取、逐字稿和 AI 筆記集中在同一個歷史記錄中。",
  ...
  browserDiagnostics: {
    ...
    consoleSource: "主控台",
    networkSource: "網路",
    consoleCount: "主控台 {{count}}",
    networkCount: "網路 {{count}}",
    afterRecording: "錄製結束後",
    seekToTime: "跳至 {{time}}",
    occurrences: "出現時間",
    message: "訊息",
    stackTrace: "堆疊追蹤",
    ...
    duration: "耗時",
    error: "錯誤",
    noIssuesTitle: "未偵測到瀏覽器問題",
    noConsoleTitle: "沒有主控台事件",
    noNetworkTitle: "沒有網路請求",
    capturedDescription: "已為此錄製擷取診斷資訊。",
  },
