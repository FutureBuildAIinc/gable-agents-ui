const messages = {
  ...
  recordingPage: {
    ...
    workflowFailed: "वर्कफ़्लो बनाना विफल रहा",
    transcriptionCompleted: "प्रतिलेखन पूरा हुआ",
    transcriptNotReady: "प्रतिलेख अभी तैयार नहीं है",
    tryAfterTranscription: "प्रतिलेखन समाप्त होने के बाद पुनः प्रयास करें।",
    titleGenerationQueued: "शीर्षक बनाया जा रहा है…",
    descriptionQueued: "विवरण बनाया जा रहा है…",
    chapterQueued: "अध्याय बनाए जा रहे हैं…",
    fillerQueued: "भराव शब्द हटाए जा रहे हैं…",
    silenceQueued: "मौन हटाया जा रहा है…",
    workflowQueued: "वर्कफ़्लो बनाया जा रहा है…",
    pageTitle: "क्लिप रिकॉर्डिंग · Clips",
    ...
    cleanUpRecording: "रिकॉर्डिंग साफ़ करें",
    createFromClip: "क्लिप से बनाएं",
  ...
  sharePage: {
    ...
    getClipsFree: "Clips मुफ़्त पाएं",
  ...
  shareDialog: {
    ...
    shareByEmail: "ईमेल से साझा करें",
    shareLink: "शेयर लिंक",
  ...
  settings: {
    ...
    labVideoEditingDescription: "नया वीडियो संपादक आज़माएँ।",
    labMeetings: "मीटिंग और ट्रांसक्रिप्शन",
  ...
  recordingInsights: {
    ...
    connectAnalytics: "Agent-Native Analytics से कनेक्ट करें",
    connectAnalyticsTitle: "Agent-Native Analytics में जारी रखें",
    exploreWithAgent: "एजेंट के साथ एक्सप्लोर करें",
    startChatAction: "चैट शुरू करें",
    trackInDashboard: "डैशबोर्ड में ट्रैक करें",
    chooseDashboardAction: "डैशबोर्ड चुनें",
  },
  libraryGrid: {
    spaceRoot: "स्पेस रूट",
  ...
  signInPrompt: {
    title: "{{intent}} के लिए मुफ़्त Clips खाता बनाएं",
  ...
  playerSettings: {
    ...
    passwordInputPlaceholder: "पासवर्ड जोड़ें",
  ...
  dictateRoute: {
    ...
    tryInBrowser: "ब्राउज़र में आज़माएँ",
    ...
    dictionaryAutoLearn: "डेस्कटॉप ऐप आपके सुधारों से सीखता है",
    dictionaryAddTerms: "शब्द जोड़ें",
    dictionaryImport: "इम्पोर्ट करें",
    dictionaryExport: "CSV एक्सपोर्ट करें",
    dictionaryImportFailed: "मान्य शब्दों वाली CSV, TSV या टेक्स्ट फ़ाइल चुनें।",
    dictionaryExported: "शब्दकोश एक्सपोर्ट हो गया",
    ...
    vocabularyRemoveFailed: "शब्द नहीं हटाया जा सका",
  },
  clipsFinalRaw: {
  ...
  browserDiagnostics: {
    ...
    consoleCount: "कंसोल {{count}}",
    networkCount: "नेटवर्क {{count}}",
    afterRecording: "रिकॉर्डिंग के बाद",
    seekToTime: "{{time}} पर जाएँ",
    occurrences: "घटनाएँ",
    message: "संदेश",
    ...
    duration: "अवधि",
    error: "त्रुटि",
    noIssuesTitle: "ब्राउज़र की कोई समस्या नहीं मिली",
    noConsoleTitle: "कोई कंसोल इवेंट नहीं",
    noNetworkTitle: "कोई नेटवर्क अनुरोध नहीं",
    capturedDescription: "इस रिकॉर्डिंग के लिए डायग्नोस्टिक्स कैप्चर किए गए।",
  },
