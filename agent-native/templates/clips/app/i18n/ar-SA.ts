const messages = {
  ...
  recordingPage: {
    ...
    workflowFailed: "فشل إنشاء سير العمل",
    transcriptionCompleted: "اكتمل النسخ",
    transcriptNotReady: "النص ليس جاهزا بعد",
    tryAfterTranscription: "حاول مرة أخرى بعد انتهاء النسخ.",
    titleGenerationQueued: "جارٍ إنشاء العنوان…",
    descriptionQueued: "جارٍ إنشاء الوصف…",
    chapterQueued: "جارٍ إنشاء الفصول…",
    fillerQueued: "جارٍ إزالة الكلمات الحشوية…",
    silenceQueued: "جارٍ إزالة فترات الصمت…",
    workflowQueued: "جارٍ إنشاء سير العمل…",
    ...
    cleanUpRecording: "تنظيف التسجيل",
    createFromClip: "إنشاء من المقطع",
  ...
  sharePage: {
    ...
    tryClips: "جرب Clips",
    getClipsFree: "احصل على Clips مجانًا",
  ...
  recordingInsights: {
    ...
    connectAnalytics: "الاتصال بـ Agent-Native Analytics",
    connectAnalyticsTitle: "المتابعة في Agent-Native Analytics",
    exploreWithAgent: "استكشف مع وكيل",
    startChatAction: "بدء الدردشة",
    trackInDashboard: "تتبّع في لوحة معلومات",
    chooseDashboardAction: "اختيار لوحة معلومات",
  },
  libraryGrid: {
  ...
  signInPrompt: {
    title: "أنشئ حساب Clips مجانيًا من أجل {{intent}}",
    ...
    or: "أو",
    legalPrefix: "بالتسجيل، أنت توافق على",
    legalTerms: "الشروط",
    legalConnector: "و",
  ...
  playerSettings: {
    ...
    passwordInputPlaceholder: "إضافة كلمة مرور",
  ...
  dictateRoute: {
    ...
    tryInBrowser: "التجربة في المتصفح",
    ...
    dictionaryAutoLearn: "يتعلّم تطبيق سطح المكتب من تصحيحاتك",
    dictionaryAddTerms: "إضافة مصطلحات",
    dictionaryImport: "استيراد",
    dictionaryExport: "تصدير CSV",
    dictionaryImportFailed:
      "اختر ملف CSV أو TSV أو ملفًا نصيًا يحتوي على مصطلحات صالحة.",
    ...
    vocabularyRemoveFailed: "تعذّرت إزالة المصطلح",
  },
  clipsFinalRaw: {
  ...
  browserDiagnostics: {
    ...
    consoleCount: "وحدة التحكم {{count}}",
    networkCount: "الشبكة {{count}}",
    afterRecording: "بعد التسجيل",
    seekToTime: "الانتقال إلى {{time}}",
    ...
    duration: "المدة",
    error: "الخطأ",
    noIssuesTitle: "لم يتم اكتشاف مشكلات في المتصفح",
    noConsoleTitle: "لا توجد أحداث في وحدة التحكم",
    noNetworkTitle: "لا توجد طلبات شبكة",
    capturedDescription: "تم التقاط التشخيصات لهذا التسجيل.",
  },
