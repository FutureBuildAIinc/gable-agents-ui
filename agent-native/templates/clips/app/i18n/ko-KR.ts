const messages = {
  ...
  recordingPage: {
    ...
    workflowFailed: "워크플로 생성에 실패했습니다.",
    transcriptionCompleted: "전사가 완료되었습니다.",
    transcriptNotReady: "스크립트가 아직 준비되지 않았습니다.",
    tryAfterTranscription: "전사가 완료된 후 다시 시도하세요.",
    titleGenerationQueued: "제목 생성 중…",
    descriptionQueued: "설명 생성 중…",
    chapterQueued: "챕터 생성 중…",
    fillerQueued: "필러 단어 제거 중…",
    silenceQueued: "무음 제거 중…",
    workflowQueued: "워크플로 생성 중…",
    pageTitle: "클립 녹화 · Clips",
    ...
    cleanUpRecording: "녹화 정리",
    createFromClip: "클립에서 만들기",
  ...
  settings: {
    ...
    labVideoEditingDescription: "새 동영상 편집기를 사용해 보세요.",
    labMeetings: "회의 및 전사",
  ...
  recordingInsights: {
    ...
    connectAnalytics: "Agent-Native Analytics에 연결",
    connectAnalyticsTitle: "Agent-Native Analytics에서 계속",
    exploreWithAgent: "에이전트와 탐색",
    startChatAction: "채팅 시작",
    trackInDashboard: "대시보드에서 추적",
    chooseDashboardAction: "대시보드 선택",
  },
  libraryGrid: {
    spaceRoot: "스페이스 루트",
  ...
  signInPrompt: {
    title: "무료 Clips 계정을 만들어 {{intent}}하세요",
    ...
    google: "Google로 가입",
    or: "또는",
    legalPrefix: "가입하면 다음에 동의하는 것입니다:",
    legalTerms: "약관",
    legalConnector: "및",
  ...
  playerSettings: {
    ...
    generatePassword: "생성",
    passwordInputPlaceholder: "비밀번호 추가",
  ...
  dictateRoute: {
    ...
    dictionaryTitle: "사전",
    dictionaryAutoLearn: "데스크톱 앱이 수정 사항을 학습합니다",
    dictionaryAddTerms: "용어 추가",
    dictionaryImport: "가져오기",
    dictionaryExport: "CSV 내보내기",
    dictionaryImportFailed:
      "유효한 용어가 포함된 CSV, TSV 또는 텍스트 파일을 선택하세요.",
    dictionaryExported: "사전을 내보냈습니다",
    ...
    vocabularyRemoveFailed: "용어를 삭제하지 못했습니다",
  },
  clipsFinalRaw: {
  ...
  browserDiagnostics: {
    ...
    consoleSource: "콘솔",
    networkSource: "네트워크",
    consoleCount: "콘솔 {{count}}",
    networkCount: "네트워크 {{count}}",
    afterRecording: "녹화 종료 후",
    seekToTime: "{{time}}로 이동",
    occurrences: "발생 시각",
    message: "메시지",
    stackTrace: "스택 추적",
    request: "요청",
    ...
    duration: "소요 시간",
    error: "오류",
    noIssuesTitle: "브라우저 문제가 감지되지 않음",
    noConsoleTitle: "콘솔 이벤트 없음",
    noNetworkTitle: "네트워크 요청 없음",
    capturedDescription: "이 녹화의 진단 정보를 캡처했습니다.",
  },
