const messages = {
  ...
  recordingPage: {
    ...
    workflowFailed: "Workflow generation failed",
    transcriptionCompleted: "Transcription complete",
    transcriptNotReady: "Transcript is not ready yet",
    tryAfterTranscription: "Try again after transcription finishes.",
    titleGenerationQueued: "Generating title…",
    descriptionQueued: "Generating description…",
    chapterQueued: "Generating chapters…",
    fillerQueued: "Removing filler words…",
    silenceQueued: "Removing silences…",
    ...
    cleanUpRecording: "Clean up recording",
    createFromClip: "Create from clip",
  ...
  sharePage: {
    ...
    agentEmptySignInPrompt: "Already have an account?",
    signUp: "Sign up",
    ownerInsights: "Owner insights",
    ownerInsightsDescription:
      "Views, completion, and viewer details are visible to editors of this clip.",
  ...
  recordingInsights: {
    ...
    connectAnalytics: "Connect to Agent-Native Analytics",
    connectAnalyticsTitle: "Continue in Agent-Native Analytics",
    exploreWithAgent: "Explore with an agent",
    startChatAction: "Start chat",
    trackInDashboard: "Track in a dashboard",
    chooseDashboardAction: "Choose dashboard",
  },
  libraryGrid: {
  ...
  signInPrompt: {
    title: "Create a free Clips account to {{intent}}",
  ...
  playerSettings: {
    ...
    passwordInputPlaceholder: "Add a password",
  ...
  browserDiagnostics: {
    ...
    duration: "Duration",
    error: "Error",
    noIssuesTitle: "No browser issues detected",
    noConsoleTitle: "No console events",
    noNetworkTitle: "No network requests",
    capturedDescription: "Diagnostics were captured for this recording.",
  },
  timeline: {
