...
export const routes: RouteConfig[] = [
  ...
  { path: '/quotes/exposure', load: () => import('./pages/quotes/Exposure.ts'), layout: 'erp' },
  ...
  { path: '/reports/exposure', load: () => import('./pages/reports/ExposureReport.ts'), layout: 'erp' },
  ...
  { path: '/admin/market-indices', load: () => import('./pages/admin/MarketIndices.ts'), layout: 'erp' },
  ...
  { path: '/accounting/accounts-payable', load: () => import('./pages/accounting/AccountsPayable.ts'), layout: 'erp' },
