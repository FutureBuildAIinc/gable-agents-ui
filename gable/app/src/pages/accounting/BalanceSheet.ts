                        ...
                        <div class="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl text-center">
                            <div class="py-4">
                                ...
                                <p class="text-2xl font-bold font-mono text-blue-400">
                                    ${formatStatementCents(report.total_assets)}
                                </p>
                            </div>
                        </div>
                        <div class="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl text-center">
                            <div class="py-4">
                                ...
                                <p class="text-2xl font-bold font-mono text-rose-400">
                                    ${formatStatementCents(report.total_liabilities)}
                                </p>
                            </div>
                        </div>
                        <div class="backdrop-blur-md bg-white/5 border border-white/10 rounded-xl text-center">
                            <div class="py-4">
                                ...
                                <p class="text-2xl font-bold font-mono text-purple-400">
                                    ${formatStatementCents(report.total_equity)}
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="py-4">
                                ...
                                ${!this._isBalanced ? html`
                                    <p class="text-xs text-red-400/70 mt-1 font-mono">
                                        Diff: ${formatStatementCents(Math.abs(report.total_assets - report.total_liabilities - report.total_equity))}
                                    </p>
                                ` : nothing}
                            </div>
                        </div>
                            ...
                            <table class="w-full text-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td class="px-4 py-2.5 text-right font-mono text-zinc-200">${formatStatementCents(report.retained_earnings)}</td>
                                    </tr>
                                    ...
                                    <tr class="font-bold ${this._isBalanced ? 'bg-emerald-500/5' : 'bg-red-500/5'}">
                                        ...
                                        <td class="px-4 py-3 text-right font-mono text-lg ${this._isBalanced ? 'text-emerald-400' : 'text-red-400'}">
                                            ${formatStatementCents(report.total_liabilities + report.total_equity)}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
